...
/*******************************************************************OVER HERE***************************************************************/
  handleCustomThemes () {
    ...
    newMuiTheme = getMuiTheme({
      palette: {
        primary1Color: document.getElementById("prim1Col"),
        primary2Color: document.getElementById("prim2Col"),
        primary3Color: document.getElementById("prim3Col"),
        accent1Color: document.getElementById("acc1Col"),
        accent2Color: document.getElementById("acc2Col"),
        accent3Color: document.getElementById("acc3Col"),
        textColor: document.getElementById("txtCol"),
        alternateTextColor: document.getElementById("altTxtCol"),
        canvasColor: document.getElementById("canvCol"),
        borderColor: document.getElementById("borCol"),
        disabledColor: document.getElementById("disCol"),
        pickerHeaderColor: document.getElementById("pickCol"),
        clockCircleColor: document.getElementById("clkCircCol"),
        shadowColor: document.getElementById("shadCol"),
      },
    });
